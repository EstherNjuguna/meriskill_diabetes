...
The predictor variables 'Pregnancies,' 'BMI,' 'DiabetesPedigreeFunction' and 'Glucose' are
statistically significant (p \< 0.05), indicating that they have a
...
The R-squared value of approximately 0.3171 suggests that about 31.71%
of the variance in the 'Outcome' variable is explained by the predictor
variables.
